    ...
    "paths": {
        ...
        "/api/events/stream": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Scope the stream to a single session id",
                        "name": "session",
                        "in": "query"
                    },
                    {
        ...
        "/api/schedules": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "Schedule spec: {agent_id, cron_expr, input, new_session} (POST only)",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "type": "object",
                ...
                "responses": {
                    ...
                    "201": {
                        "description": "created schedule (POST)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/schedules/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "schedule, deletion result, or history",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
